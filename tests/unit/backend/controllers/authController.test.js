...
describe('authController', () => {
  ...
  it('refuse les tokens invalides, introuvables, inactifs ou en erreur de lecture', async () => {
    ...
    await expect(
      ...
      res: { statusCode: 401, body: { error: 'Token invalide ou expiré' } },
    })
  ...
  it('valide les contraintes de changement de mot de passe', async () => {
    ...
    await expect(
      ...
      res: {
        statusCode: 400,
        body: { error: 'Le nouveau mot de passe doit contenir au moins 4 caractères' },
      },
    })
    ...
    await expect(
      ...
      res: {
        statusCode: 400,
        body: { error: 'Le nouveau mot de passe doit être différent du mot de passe actuel' },
      },
    })
  ...
  it('change un mot de passe obligatoire sans verifier l ancien et remonte les erreurs', async () => {
    ...
    await expect(
      ...
      res: { statusCode: 200, body: { message: 'Mot de passe modifié avec succès' } },
    })
    expect(models.updatePassword).toHaveBeenCalledWith(2, 'nouveau')

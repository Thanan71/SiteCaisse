        ...
        >
          ...
          <div class="form-row article-fields">
            <div class="form-group form-group-article">
              <label :for="'edit-art-name-' + index">Nom de l'article</label>
              <input
                :id="'edit-art-name-' + index"
            ...
            <div class="form-group form-group-qty">
              <label :for="'edit-art-qty-' + index">Qté</label>
              <input
                :id="'edit-art-qty-' + index"
            ...
            <div class="form-group form-group-price">
              <label :for="'edit-art-price-' + index">Prix (€)</label>
              <input
                :id="'edit-art-price-' + index"
...
watch(() => props.vente, (newVente) => {
  if (newVente) {
    ...
    form.articles = newVente.articles && newVente.articles.length > 0
      ? newVente.articles.map(a => ({
          article: a.article || '',

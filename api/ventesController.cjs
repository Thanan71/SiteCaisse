...
router.post('/', (req, res) => {
  try {
    ...
    const id = createVente(article, qte, prix, type_paiement, artisan_id, vendeur_id, date_vente);
...
router.put('/:id', (req, res) => {
  try {
    ...
    const updated = updateVente(id, req.body);
